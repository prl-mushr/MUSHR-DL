...
model = trajectory(HEIGHT,WIDTH,CHANNELS)
model_name = 'trajectory_1.h5'
...
output_path = "C:/Python36/DonkeySimWin/Outputs_pytorch" 
counter = 0
for i in range(1):
...
# log_file = 'log_{}_{}_{}_{}_{}.npy'.format(a.tm_year,a.tm_mon,a.tm_mday,a.tm_hour,a.tm_min)
